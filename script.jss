...
(function() {
    ...
    const MASTER_WORDS = {
        ...
        // WORLD 2: ENCHANTED FOREST (600 words) - Ready for future expansion
        world2: {
        ...
        // WORLD 3: CRYSTAL CAVERNS (600 words) - Ready for future expansion
        world3: {
        ...
        // WORLD 4: SKY CITADEL (600 words) - Ready for future expansion
        world4: {
            name: "Sky Citadel",
            icon: "☁️",
            unitType: "Cloud",
        ...
        // WORLD 5: DRAGON'S PEAK (600 words) - Ready for future expansion
        world5: {
            name: "Dragon's Peak",
            icon: "🐉",
            unitType: "Scale",
        ...
        // WORLD 6: STAR FORGE (600 words) - Ready for future expansion
        world6: {
            name: "Star Forge",
            icon: "⭐",
            unitType: "Star",
    ...
    // ---------- GRACE SYSTEM (1% per failure, stacks to 99%) ----------
    const ingotGrace = {};
    for (let i = 1; i <= 180; i++) {
        ingotGrace[i] = 0;
    }
    ...
    // ---------- MOCK LEADERBOARD - 30 PLAYERS, TOP AT 580 ----------
    ...
    function processWordCardQueue() {
        ...
        // MODIFIED: Dynamic font size based on word length
